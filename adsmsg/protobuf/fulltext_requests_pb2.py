...
FulltextRequests = _reflection.GeneratedProtocolMessageType('FulltextRequests', (_message.Message,), dict(
...
FulltextRequest = _reflection.GeneratedProtocolMessageType('FulltextRequest', (_message.Message,), dict(
